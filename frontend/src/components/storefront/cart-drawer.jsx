      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        <div className="flex items-start justify-between gap-2">
          <Link
            ...
            className="truncate text-md font-semibold text-sf-ink"
          >
            {item.name}
          </Link>
          <button
          ...
          <div className="flex flex-col gap-0.5">
            {options.map((o) => (
              <p key={o.label ?? o.name} className="text-md text-sf-ink">
                ...
                <span className="">: {o.valueLabel ?? o.value}</span>
              </p>
            ))}
          </div>
        ) : null}
        ...
        {hasItems ? (
          <div className="flex flex-col gap-3 bg-primary-foreground px-5 py-4">
            <div className="flex items-center justify-between text-sm text-sf-ink">
              <span>Total</span>
              <span className="text-base font-bold">{formatPrice(cart.total)}</span>
            </div>
